    ...
    public void configureClientInboundChannel(ChannelRegistration registration) {
        registration.interceptors(new ChannelInterceptor() {
            ...
            public Message<?> preSend(Message<?> message, MessageChannel channel) {
                ...
                if (username == null || password == null) throw new org.springframework.security.access.AccessDeniedException("WebSocket authentication is required.");
                UserDetails user = playerService.loadUserByUsername(username);
                if (!passwordEncoder.matches(password, user.getPassword()) || !user.isEnabled()) throw new org.springframework.security.access.AccessDeniedException("Invalid WebSocket credentials.");
